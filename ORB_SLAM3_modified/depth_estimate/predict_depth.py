...
#print(conf)
conf['save_dir'] = '/home/tyy/.cache/torch/hub/checkpoints'
#conf['pretrained_resource'] = 'local::./ZoeD_M12_N.pt'
conf['pretrained_resource'] = 'local::/home/tyy/.cache/torch/hub/checkpoints/ZoeD_M12_N.pt'
...
img_dir = '/media/tyy/48B6A5A5B6A593CA/Linux/DateSet/Own/huatan/data/data/*.png'
for img in tqdm.tqdm(glob.glob(img_dir)):
    ...
    fpath = os.path.join('/media/tyy/48B6A5A5B6A593CA/Linux/output')
