...
public:
    ...
    ORBextractor* mpORBextractorLeft, *mpORBextractorRight;//左右目图像特征点提取器
    ...
    cv::Mat mDescriptors, mDescriptorsRight;//左右目图像特征点描述子
